...
public class Configuration {
    ...
    public Configuration(String id, String configurationId, String name, String description, Long version, Boolean active, String owner, LocalDateTime createdDate, LocalDateTime lastModifiedDate, List<String> adminIds, List<Setting> settings, Map<String, Object> additionalProperties) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public Configuration build() {
            return new Configuration(id, configurationId, name, description, version, active, owner, createdDate, lastModifiedDate, adminIds, settings, additionalProperties);
        }
    }
}
